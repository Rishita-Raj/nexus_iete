...
export function InfiniteMovingCardsDemo() {
  return (
    ...
    >
        <h1 className="ml-20 sm:ml-30 mb-30 font-bold  text-4xl md:text-6xl my-4  justify-center items-center flex  bg-gradient-to-r from-blue-300 via-gray-700 to-gray-400    text-transparent bg-clip-text pb-5  w-fit mx-3">
